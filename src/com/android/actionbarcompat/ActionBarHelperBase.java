...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    /**
     * Returns the {@link android.view.ViewGroup} for the action bar on phones (compatibility action bar). Can return null, and will return null on Honeycomb.
     */
    ...
    /**
     * Adds an action button to the compatibility action bar, using menu information from a {@link android.view.MenuItem}. If the menu item ID is
     * <code>menu_refresh</code>, the menu item's state can be changed to show a loading spinner using
    ...
    private View addActionItemCompatFromMenuItem(final MenuItem item) {
        ...
        // Create the button
        ImageButton actionButton = new ImageButton(mActivity, null, itemId == android.R.id.home ? R.attr.actionbarCompatItemHomeStyle
